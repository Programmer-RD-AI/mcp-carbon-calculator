...
class Electricity(BaseModel):
    ...
    def get_factor(self, state: Union[ElectricityState, str]) -> EmissionFactor:
...
class Gas(BaseModel):
    ...
    def get_scope3(self, state: Union[GasState, str]) -> Scope3:
...
class EmissionFactors(BaseModel):
    ...
    def for_state(self, state: Union[ElectricityState, GasState, str]) -> dict:
        try:
